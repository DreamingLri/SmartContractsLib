...
abstract contract TimedDrop is Teams {
  ...
  uint256 public publicDropTime = 1685628120;
...
abstract contract EarlyMintIncentive is Teams, ERC721A, ProviderFees {
  uint256 public PRICE = 1666 ether;
  uint256 public EARLY_MINT_PRICE = 1000 ether;
    ...
    , TimedDrop
{
  constructor(
    ...
    string public _baseTokenURI = "ipfs://bafybeigmnutnaaoz64aovzke5fusn6d7acfdhzpx2egrcqtnk2wnuuxxfe/";
  ...
  function contractURI() public pure returns (string memory) {
    return "https://metadata.mintplex.xyz/NseUrYOS9XLj4F5Bm6pH/contract-metadata";
  }
...
// File: contracts/MumeUniversePortalContract.sol
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.0;

contract MumeUniversePortalContract is ERC721APlus {
    constructor() ERC721APlus("MUME Universe Portal ", "MUP"){}
}
