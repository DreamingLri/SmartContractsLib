...
contract Hop is HOPDeployer, Context, Ownable {
  
    // common addresses
    address private _owner;
    address private HOPTeam;
    address private CharityHOP;
    ...
    string public override name = "Hop";
    string public override symbol = "HOP";
    ...
    constructor(uint totalSupplyValue, address HOPTeamAddress, address CharityHOPAddress) {
        // set total supply
        totalSupply = totalSupplyValue;
        
        // designate addresses
        _owner = msg.sender;
        HOPTeam = HOPTeamAddress;
        CharityHOP = CharityHOPAddress;
        
        // split the tokens according to agreed upon percentages
        balances[HOPTeam] =  totalSupply * 1 / 100;
        balances[CharityHOP] = totalSupply * 1 / 100;
    ...
    // Get the address of the token's HOPTeam pot
