...
contract MyToken is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 888000000000008 * (10**9);
    ...
    uint256 public _maxTxAmount = 888000000000008 * 10**9;

    bool public _isTradeOpen = true;
    uint256 public blackListTimeLimit;
    ...
    constructor() {
        ...
        //set blacklist time limit
        blackListTimeLimit = block.timestamp + 3600; 
    ...
    function blackListAccountFirstHour(address account) external onlyOwner {
        require(block.timestamp <= blackListTimeLimit, "Time for blacklisting has ended");
