...
contract VetroMetaverseGames is ERC20 {
    ...
    string public constant name = "Vetro Games Token";
    ...
    uint256 public constant requestMinimum = 0.01 ether / 1;
    uint256 public tokensPerEth = 20e5;
