...
//SPDX-License-Identifier: MIT
pragma solidity ^0.4.26;
interface IERC998_ERC721_Enumerable {
...
//SPDX-License-Identifier: MIT
pragma solidity ^0.4.26;
interface IERC998_ERC20_Enumerable {
...
pragma solidity ^0.4.26;
interface IERC998_ERC721_BottomUp {
...
contract ComposableTopDown is
    IERC721,
    IERC998_ERC721,
    IERC998_ERC721_Enumerable,
    IERC998_ERC20,
    IERC998_ERC20_Enumerable
{
    ...
    function safeTransferChild(
        ...
        IERC721(_childContract).safeTransferFrom(this, _to, _childTokenId);
    ...
    function transferChildToParent(
        ...
        IERC998_ERC721_BottomUp(_childContract).transferToParent(
            address(this),
            _toContract,
            _toTokenId,
            _childTokenId,
    ...
    function getChild(
        ...
        IERC721(_childContract).transferFrom(_from, this, _childTokenId);
    }
        ...
        returns (address childContract)
    {
        require(
            ...
            "Contract address doesnot exist for this token and index."
        );
    ...
    function transferERC20(
        ...
        require(
            IERC20_ERC223(_erc20Contract).transfer(_to, _value),
    ...
    function transferERC223(
        ...
        require(
            IERC20_ERC223(_erc223Contract).transfer(_to, _value, _data),
    ...
    function getERC20(
        ...
        require(
            IERC20_ERC223(_erc20Contract).transferFrom(_from, this, _value),
            "ERC20 transfer failed."
        );
    }
