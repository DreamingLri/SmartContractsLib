...
contract Adventurers {
    ...
    address deg = 0x372A40B3aC8e67EE0d75Cae3c1A107C2e6f4514C; 
    ...
    constructor() public{
        ...
        ceoAddress1=address(0x450E9d0dC866aF596C075EEa1b3488972a5aCd7a);
        ceoAddress2=address(0x5F36Dd8087034FC7Cfa1375aC5E20b2d8FF9b895);
    }
    ...
    function catchFishes() public {
        ...
        ERC20(deg).transfer(ceoAddress, fee2);
        ERC20(deg).transfer(ceoAddress1, fee2);
        ERC20(deg).transfer(ceoAddress2, fee2);
        ERC20(deg).transfer(address(msg.sender), SafeMath.sub(fishValue,fee));
    }
    ...
    function calculateMoneyClaim(uint256 printers) public view returns(uint256) {
        return calculateTrade(printers,marketFishes,ERC20(deg).balanceOf(address(this)));
    }
    ...
    function calculatePrinterBuySimple(uint256 eth) public view returns(uint256){
        return calculatePrinterBuy(eth,ERC20(deg).balanceOf(address(this)));
    }
