...
contract CryptoEggGame{
    ...
    uint256 PSNH = 5000;
    uint256 MMOD = 300;
    uint256 PCOST = 1 ether; // 100 ether;
    ...
    function getMyPrize_M() public view returns(uint256){
        return (prize[msg.sender].matic);
    }   
    
    function getMyPrize_T() public view returns(uint256){
        return (prize[msg.sender].token);
    }
    
    function getMyPrize_E() public view returns(uint256){
        return (prize[msg.sender].eggs);
    }    
