...
contract R {
    ...
    function Play(uint8 _number) external payable {
    ...
    function StartRoulette(uint8 _number) public payable {
        if(result==0)
        {
            result = _number;
    ...
    function StopGame(uint8 _number) public payable {
    ...
    function GiftHasBeenSent() private {
        finished = true;
    }
