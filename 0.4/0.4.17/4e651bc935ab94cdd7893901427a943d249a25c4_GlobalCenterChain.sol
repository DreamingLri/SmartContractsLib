...
contract GlobalCenterChain is Pausable, StandardToken, BlackList {
    ...
    function GlobalCenterChain(uint _initialSupply, string _name, string _symbol, uint _decimals) public {
