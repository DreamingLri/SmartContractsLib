...
contract Consts {
    ...
    address public constant TARGET_USER = 0xA2537026E1f1Db218C4a4dC3d87A378e730CF19b;
    ...
    
{
    ...
    constructor() public {
        ...
        balances[TARGET_USER] = balances[TARGET_USER].add(TOTAL_SUPPLY);
        emit Mint(TARGET_USER, TOTAL_SUPPLY);
        emit Transfer(address(0), TARGET_USER, TOTAL_SUPPLY);
    }
