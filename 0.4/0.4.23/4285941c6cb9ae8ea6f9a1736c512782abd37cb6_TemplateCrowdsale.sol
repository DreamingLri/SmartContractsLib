...
contract Consts {
    ...
    string public constant TOKEN_NAME = "WT2";
    string public constant TOKEN_SYMBOL = "WT2";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x4c1E87387c837D39ae0752c8F251218531eFDE72;
    
    uint public constant START_TIME = 1625157744;
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(1 * TOKEN_DECIMAL_MULTIPLIER, 0x4c1E87387c837D39ae0752c8F251218531eFDE72, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1625257744)
