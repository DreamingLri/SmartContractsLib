...
contract receipt {
  ...
  function issueReceipt(address recipient, string merchantName, string itemName, uint256 itemValue, uint256 itemAgeRestriction) public constant returns (address, string, string, uint256, uint256) {

    return (recipient, merchantName, itemName, itemValue, itemAgeRestriction);
