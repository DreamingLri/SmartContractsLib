...
contract bTRXToken is Pausable, StandardTokenWithFees, BlackList {
    ...
    function bTRXToken(uint _initialSupply, string _name, string _symbol, uint8 _decimals) public {
