...
library SafeMath {
  ...
  function div(uint a, uint b) internal pure returns (uint) {
    // assertCheck(b > 0); // Solidity automatically throws when dividing by 0
    uint c = a / b;
    // assertCheck(a == b * c + a % b); // There is no case in which this doesn't hold
    return c;
  }
  ...
  function assertCheck(bool assertion) pure internal {
    if (!assertion) {
      revert();
    }
  }
 ...
 */
contract HereToo is PausableToken, MintableToken {
