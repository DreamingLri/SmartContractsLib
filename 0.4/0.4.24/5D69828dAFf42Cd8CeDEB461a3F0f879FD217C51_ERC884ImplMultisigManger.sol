...
import "../Ownable.sol";
import "./ERC884Impl.sol";

contract ERC884ImplMultisigManger is Ownable {
    mapping(uint256 => bool) public ownersNonceMap;
    mapping(uint256 => bool) public boardOfDirectorsNonceMap;
    mapping(uint256 => bool) public whiteListingNonceMap;
    ...
    function setBoardOfDirectors(
        ...
        uint8[] sigVB,
        bytes32[] sigRB,
        bytes32[] sigSB, uint ownersNonce) public {

        require(!ownersNonceMap[ownersNonce], "nonce used");
        ownersNonceMap[ownersNonce] = true;
    ...
    function addLabel(address addr, bytes32 label, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint whiteListingNonce) public {

        require(!whiteListingNonceMap[whiteListingNonce], "nonce used");
        whiteListingNonceMap[whiteListingNonce] = true;
    ...
    function removeLabel(address addr, bytes32 label, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint whiteListingNonce) public {
    ...
    function addVerified(address addr, bytes32 hash, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint whiteListingNonce) public {
    ...
    function removeVerified(address addr, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint whiteListingNonce) public {
    ...
    function updateVerified(address addr, bytes32 hash, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint whiteListingNonce) public {
    ...
    function cancelAndReissue(address original, address replacement, uint8[] sigV, bytes32[] sigR, bytes32[] sigS,
        uint8[] sigVB,
        bytes32[] sigRB,
        bytes32[] sigSB, uint boardOfDirectorsNonce) public {

        require(!boardOfDirectorsNonceMap[boardOfDirectorsNonce], "nonce used");
        boardOfDirectorsNonceMap[boardOfDirectorsNonce] = true;
    ...
    function split(uint splitFactor_, uint splitFactorDecimals_, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {
    ...
    function updateURI(string uri, string md5hash, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {

        require(!boardOfDirectorsNonceMap[boardOfDirectorsNonce], "nonce used");
        boardOfDirectorsNonceMap[boardOfDirectorsNonce] = true;

        onlySigners(boardOfDirectorsMultisig,
            abi.encodePacked("updateURI", erc884, uri, md5hash, boardOfDirectorsNonce),
            sigV, sigR, sigS);

        ERC884Impl token = ERC884Impl(erc884);
        token.updateURI(uri, md5hash);
    ...
    function mint(address to, uint256 value, uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {
    ...
    function finishMinting(uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {
    ...
    function pause(uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {
    ...
    function unpause(uint8[] sigV, bytes32[] sigR, bytes32[] sigS, uint boardOfDirectorsNonce) public {
