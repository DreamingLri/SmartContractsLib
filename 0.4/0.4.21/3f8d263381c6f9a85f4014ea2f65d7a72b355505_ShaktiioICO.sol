...
contract ShaktiioICO is Ownable {
  ...
  uint256 public constant RATE = 22000; // Number of tokens per Ether
  uint256 public constant CAP = 25205; // Cap in Ether
  uint256 public START;
  uint256 public constant DAYS = 1; // 45 Day
  
  uint256 public constant initialTokens = 22000 * 10**18; // Initial number of tokens available
