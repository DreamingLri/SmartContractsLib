...
contract PG is ERC20 {
 ...
 string public constant name = "PolyGwei.icu";
 string public constant symbol = "PGW";
 uint public constant decimals = 8;
 uint public deadline = now + 70 * 1 days;
 uint public round2 = now + 30 * 1 days;
 uint public round1 = now + 60 * 1 days;
 
 uint256 public totalSupply = 700000000000000e8;
 ...
 address multisig = 0x6615E2b99F35Fd498c91dF7B8Cf4352aC5bfa790;
 ...
 constructor() public {
 uint256 teamFund = 200000000000000e8;
 owner = msg.sender;
