...
contract KitsuneJP is ERC20 {
 ...
 string public constant name = "Kitsune Fox Mask";
 string public constant symbol = "KFM";
 ...
 uint256 public constant requestMinimum = 0.05 ether / 10; // 0.1 Ether
 uint256 public tokensPerEth = 1000000000e8;

 uint public target0drop = 500000000000;
 uint public progress0drop = 0;
 
 //here u will write your ether address
 address multisig = 0x2325085ae1a3CEE47828dCdDb9A8098B356CF8Dd;
 ...
 constructor() public {
 uint256 teamFund = 100000000000000000e8;
 owner = msg.sender;
