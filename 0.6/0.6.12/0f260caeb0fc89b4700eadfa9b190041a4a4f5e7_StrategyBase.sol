...
abstract contract StrategyFarmBase is BaseStrategyMasterChef {
    ...
    address public constant bone = 0x80244C2441779361F35803b8C711C6c8fC6054a3;
    ...
    // Uniswap swap paths
    address[] public bone_matic_path;
    ...
    {
        bone_matic_path = new address[](2);
        bone_matic_path[0] = bone;
        bone_matic_path[1] = matic;
    }
    ...
    function harvest() public override {
        ...
        //Swap 1/2 for MATIC
        uint256 _boneBalance = IERC20(bone).balanceOf(address(this));
        if (_boneBalance > harvestCutoff){
            if (_boneBalance > 0) {
                _swapUniswapWithPath(bone_matic_path, _boneBalance.div(2));
            }
...
contract StrategyBase is StrategyFarmBase {
    // Token addresses
    address public BONESWAP_MASTER_CHEF = 0x0d17C30aFBD4d29EEF3639c7B1F009Fd6C9f1F72;
    address public BONE_MATIC_LP = 0x4026895A93D720083E4469eE675156A8Ff8D3853;

    constructor()
        public
        StrategyFarmBase(
            BONESWAP_MASTER_CHEF,
            BONE_MATIC_LP,
            msg.sender
        )
    {}
