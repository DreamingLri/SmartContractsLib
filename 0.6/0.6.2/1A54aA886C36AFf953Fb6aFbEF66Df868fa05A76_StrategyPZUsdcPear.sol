...
// File: contracts/strategy/StrategyPZUsdcPear.sol
pragma solidity 0.6.12;

contract StrategyPZUsdcPear is BaseStrategyLPSingle {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;
    ...
    function _vaultHarvest() internal override {
        IPearzap(stakingRewardsAddress).deposit(pid, 0, feeAddress);
    }
