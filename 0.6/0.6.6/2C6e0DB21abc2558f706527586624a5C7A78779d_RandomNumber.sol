...
// File: ChainLink/RandomNumberPolygon.sol
...
contract RandomNumber is VRFConsumerBase, Ownable {
    ...
    function ownerClaimToken() external onlyOwner {
        ...
        require(LINK.balanceOf(address(this)) > 0, "Not enough LINK for owner claim token");
