...
contract DAF is Ownable { 
	...
	function usdtSubscription(uint256 _amountIn)  public {
    	...
    	require(dafAllowanceContractOnBehalfUser >= _amountIn, "contract not allowed to move tether");
	    ...
	    if (_cashMode){
	        ...
	        require(_ethAmountIn > 0, "New balance higher");
	        toAllocate = (_ethAmountIn*nbTotalParts)/oldEtherBalance;
	    }
	    
	    require(toAllocate > 0, "You need to subscribe more than one part");
