...
// File contracts/flatten/AutoMaticStrategyQuickLp.sol
...
// File contracts/factory/StrategyFactory.sol

contract AutoMaticStrategyFactory is Ownable {
    address[] public strategies;
    function deploy(address _lp, address _rewardPool, bool _compound) external returns (address) {
        require(msg.sender == owner() || tx.origin == owner(), "!owner");
        
        AutoMaticStrategyQuickLp strategy = new AutoMaticStrategyQuickLp(_lp, _rewardPool);
        if (_compound == true) strategy.enableAutoCompound(true);
